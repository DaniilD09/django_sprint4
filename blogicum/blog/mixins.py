...
# 1. по прошлым всем правкам, я думаю ты попросишь сделать отдельный файл для Миксин
...
# 5. пытался сделать отдельное приложение users не смог пройти автотесты и не смог нормально поменять шаблоны, поэтому все в куче
# 6. скажу честно кое где списал кое где ребята помогали кое где сам
# 7. очень надеюсь что направишь и подскажешь что можно сделать хорошо очень хочу сделать красиво и правильно
